    ...
    def is_chain_valid(self, chain):
        ...
        while block_index < len(chain):
            ...
            if block['previous_hash'] != previous_block['current_hash']:  #self.hash(previous_block):
                ...
                print("prev block cur has:" + previous_block['current_hash'])
                return False
            ...
            print("hash_op:"+ hash_operation)
            print("cur_hash:"+block['current_hash'])
        ...
        for node in network:
            ...
            if response.status_code == 200:
                ...
                if length > max_length and self.is_chain_valid(chain):
                    ...
                    max_length = length
                    longest_chain = chain
                elif self.is_chain_valid(chain) == False:
                    print("chain not valid - len:" + str(length))
        print("longest chain:")
        print(longest_chain)
        if longest_chain:
            print("updated..............")
